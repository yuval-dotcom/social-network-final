export const languages = {
  he: {
    ...
    profile: {
      eyebrow: "האזור האישי",
      title: "הפרופיל שלי",
      body: "מבט אחד על המשתמש המחובר, החברים, קבוצות הלימוד והפוסטים האחרונים שלו.",
      subtitle: "הפרופיל מחבר בין הזהות שלך, הקבוצות שבהן אתה חבר והתוכן שפרסמת.",
      refresh: "רענון פרופיל",
      loading: "טוען פרופיל...",
      failed: "טעינת הפרופיל נכשלה.",
      unknownUsername: "student",
      defaultMajor: "סטודנט",
      friends: "חברים",
      groups: "קבוצות",
      posts: "פוסטים",
      friendList: "חברים ללימודים",
      studyGroups: "קבוצות לימוד",
      recentPosts: "פוסטים אחרונים",
      noFriends: "אין עדיין חברים להצגה.",
      noGroups: "אין עדיין קבוצות להצגה.",
      noPosts: "עדיין אין פוסטים שלך.",
      publicGroup: "ציבורית",
      privateGroup: "פרטית",
      unknownGroup: "קבוצה"
    },
    ...
    crud: {
      ...
      newDisplayName: "שם מלא חדש",
      newMajor: "מסלול לימודים חדש",
      from: "מתאריך",
      to: "עד תאריך",
      feed: "פיד",
      myPosts: "הפוסטים שלי"
  ...
  en: {
    ...
    profile: {
      ...
      unknownUsername: "student",
      defaultMajor: "Student",
      friends: "Friends",
      groups: "Groups",
      posts: "Posts",
      friendList: "Study friends",
      studyGroups: "Study groups",
      recentPosts: "Recent posts",
      noFriends: "There are no friends to show yet.",
      noGroups: "There are no groups to show yet.",
      noPosts: "You have not published posts yet.",
      publicGroup: "Public",
